...
{
    public class AshWoodJavelin : ModProjectile
    {
        public override string Texture => VanillaFlexibility.AssetPath + "Textures/Projectiles/WoodenJavelins/AshWoodJavelin";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 18; i++)
            {
                Dust dust = Dust.NewDustDirect(usePos, Projectile.width, Projectile.height, DustID.Ash);
