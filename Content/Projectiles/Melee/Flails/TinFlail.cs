...
namespace VanillaFlexibility.Content.Projectiles.Melee.Flails
{
    ...
    public class TinFlail : ModProjectile
    {
        private const string ChainTexturePath = "VanillaFlexibility/Content/Projectiles/Melee/Flails/TinFlailChain";
        ...
        {
            Projectile.CloneDefaults(ModContent.ProjectileType<CopperFlail>());
