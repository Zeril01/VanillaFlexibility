...
namespace VanillaFlexibility.Content.Items.Armor
{
    ...
    public class FlinxFurHeadphones : ModItem
    {
        public static readonly int SummonDamageBonus = 3;
        public static readonly int WhipSpeedMultiplierBonus = 8;
        public static readonly int MaxTurretIncrease = 1;

        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(SummonDamageBonus, WhipSpeedMultiplierBonus);
        public static LocalizedText SetBonusText { get; private set; }

        public override void SetStaticDefaults()
        {
            ArmorIDs.Head.Sets.DrawFullHair[Item.headSlot] = true;
            SetBonusText = this.GetLocalization("SetBonus").WithFormatArgs(MaxTurretIncrease);
        }
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            player.GetAttackSpeed(DamageClass.Summon) += WhipSpeedMultiplierBonus / 100f;
        }
